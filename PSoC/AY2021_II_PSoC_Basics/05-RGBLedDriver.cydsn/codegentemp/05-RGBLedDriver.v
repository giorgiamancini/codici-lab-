// ======================================================================
// 05-RGBLedDriver.v generated from TopDesign.cysch
// 04/02/2021 at 11:09
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3de6ab0e-8042-4d0b-8c25-94fb81a183be"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__BLU_Led_net;
	wire [0:0] tmpFB_0__BLU_Led_net;
	wire [0:0] tmpIO_0__BLU_Led_net;
	wire [0:0] tmpINTERRUPT_0__BLU_Led_net;
	electrical [0:0] tmpSIOVREF__BLU_Led_net;

	cy_psoc3_pins_v1_10
		#(.id("334fd8be-dd80-4863-ae49-4290f6967bc7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BLU_Led
		 (.oe(tmpOE__BLU_Led_net),
		  .y({Net_211}),
		  .fb({tmpFB_0__BLU_Led_net[0:0]}),
		  .io({tmpIO_0__BLU_Led_net[0:0]}),
		  .siovref(tmpSIOVREF__BLU_Led_net),
		  .interrupt({tmpINTERRUPT_0__BLU_Led_net[0:0]}),
		  .annotation({Net_206}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BLU_Led_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_1345 = 1'h0;
