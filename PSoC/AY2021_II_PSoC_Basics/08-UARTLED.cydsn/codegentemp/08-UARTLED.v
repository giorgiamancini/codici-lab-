// ======================================================================
// 08-UARTLED.v generated from TopDesign.cysch
// 03/31/2021 at 17:25
...
module top ;
    ...
    cy_annotation_universal_v1_0 Terminal_1 (
        .connect({
            Net_1657,
            Net_1654[1:0],
            Net_1589
    ...
    defparam Terminal_1.comp_name = "UART_Terminal_sm1_v0_0";
    defparam Terminal_1.port_names = "RX, Rx1_1, Rx1_0, TX";
    defparam Terminal_1.width = 4;
    ...
    UART_v2_50_0 UART (
        ...
        .rx_clk(Net_1586),
        .rx_data(Net_1587),
        .rx_interrupt(Net_1661),
        .tx(Net_1660),
        .tx_clk(Net_1590),
        .tx_data(Net_1591),
        .tx_en(Net_1592),
        .tx_interrupt(Net_1593));
	...
	wire [0:0] tmpOE__Pin_uart_net;
	wire [0:0] tmpFB_0__Pin_uart_net;
	wire [0:0] tmpIO_0__Pin_uart_net;
	wire [0:0] tmpINTERRUPT_0__Pin_uart_net;
	electrical [0:0] tmpSIOVREF__Pin_uart_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_uart
		 (.oe(tmpOE__Pin_uart_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_uart_net[0:0]}),
		  .io({tmpIO_0__Pin_uart_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_uart_net),
		  .interrupt({tmpINTERRUPT_0__Pin_uart_net[0:0]}),
		  .annotation({Net_1664}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_uart_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
