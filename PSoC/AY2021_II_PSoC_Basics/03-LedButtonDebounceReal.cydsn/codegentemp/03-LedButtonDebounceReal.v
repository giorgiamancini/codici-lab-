// ======================================================================
// 03-LedButtonDebounceReal.v generated from TopDesign.cysch
// 03/28/2021 at 12:12
...
module top ;
	...
	wire [0:0] tmpOE__PushButton_net;
	wire [0:0] tmpFB_0__PushButton_net;
	wire [0:0] tmpIO_0__PushButton_net;
	wire [0:0] tmpINTERRUPT_0__PushButton_net;
	electrical [0:0] tmpSIOVREF__PushButton_net;

	cy_psoc3_pins_v1_10
		#(.id("99496d57-f61e-4988-97a0-d73ef953ec59"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		PushButton
		 (.oe(tmpOE__PushButton_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PushButton_net[0:0]}),
		  .io({tmpIO_0__PushButton_net[0:0]}),
		  .siovref(tmpSIOVREF__PushButton_net),
		  .interrupt({tmpINTERRUPT_0__PushButton_net[0:0]}),
		  .annotation({Net_39}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PushButton_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
