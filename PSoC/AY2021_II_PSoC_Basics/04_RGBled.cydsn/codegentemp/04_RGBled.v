// ======================================================================
// 04_RGBled.v generated from TopDesign.cysch
// 03/28/2021 at 11:57
...
module top ;
    ...
    cy_annotation_universal_v1_0 RGB_Green (
        .connect({
            Net_74,
            Net_82
        })
    );
    defparam RGB_Green.comp_name = "LED_v1_0";
    defparam RGB_Green.port_names = "A, K";
    defparam RGB_Green.width = 2;
    ...
    defparam Timer_LED.Resolution = 8;
