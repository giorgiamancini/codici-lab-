// ======================================================================
// Project2.v generated from TopDesign.cysch
// 04/07/2021 at 15:21
...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("8e4a3d37-a260-4d27-be2c-19d650f8c9d9/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_psoc3_pins_v1_10
		#(.id("8e4a3d37-a260-4d27-be2c-19d650f8c9d9/93327f79-f616-44c2-ae10-d5db5cc52542"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("8e4a3d37-a260-4d27-be2c-19d650f8c9d9/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module top ;
    ...
    cy_annotation_universal_v1_0 Potentiometer (
        .connect({
            Net_93,
            Net_115,
            Net_94
    ...
    defparam Potentiometer.comp_name = "Potentiometer_sm1_v1_0";
    defparam Potentiometer.port_names = "T1_1, T2_1, T2_2";
    defparam Potentiometer.width = 3;

	wire [0:0] tmpOE__R_Pin_net;
	wire [0:0] tmpFB_0__R_Pin_net;
	wire [0:0] tmpIO_0__R_Pin_net;
	wire [0:0] tmpINTERRUPT_0__R_Pin_net;
	electrical [0:0] tmpSIOVREF__R_Pin_net;
	...
	cy_psoc3_pins_v1_10
		...
		R_Pin
		 (.oe(tmpOE__R_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__R_Pin_net[0:0]}),
		  .analog({Net_98}),
		  .io({tmpIO_0__R_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__R_Pin_net),
		  .interrupt({tmpINTERRUPT_0__R_Pin_net[0:0]}),
		  .annotation({Net_94}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__R_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam PWR_1.comp_name = "Power_sm1_v1_0";
    defparam PWR_1.port_names = "T1, Terminal_1, Terminal_2";
    defparam PWR_1.width = 3;
